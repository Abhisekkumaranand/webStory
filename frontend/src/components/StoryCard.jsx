  ...
  const content = (
    ...
    >
      <CardContent className="p-0">
        <div className="w-full h-40 md:h-48 bg-gradient-to-br from-gray-100 to-gray-200 overflow-hidden relative">
          {thumb ? (
            <img
              src={thumb}
              alt={`${title} thumbnail`}
      ...
      <div className="p-3 md:p-4">
        <h3
          ...
          className="text-lg md:text-xl font-bold leading-tight text-gray-900 truncate mb-2"
        >
          {title}
        </h3>
